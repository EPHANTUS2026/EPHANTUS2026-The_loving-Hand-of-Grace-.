...
export async function dbRpc(fn, body={}, {admin=true, token}={}){
  return request(`/rest/v1/rpc/${encodeURIComponent(fn)}`,{method:'POST',body,admin,token,headers:{Prefer:'return=representation'}});
}
